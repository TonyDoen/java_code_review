...
public final class SmallestRotationWithHighestScore {
    private SmallestRotationWithHighestScore() {
    }
    /**
     *      url: http://www.cnblogs.com/grandyang/p/9272921.html
     *      url: https://leetcode.com/problems/smallest-rotation-with-highest-score/discuss/118725/Easy-and-Concise-5-lines-Solution-C++JavaPython?page=2
     *
    ...
    private static void testBestRotation() {
        int[] A = new int[]{2, 3, 1, 4, 0};
        int res = bestRotation(A);
