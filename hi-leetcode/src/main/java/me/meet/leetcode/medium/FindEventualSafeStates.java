...
public final class FindEventualSafeStates {
    private FindEventualSafeStates() {
    }
     ...
     */
    /**
     * 0：未访问; 1：以访问; 2：安全; 3：成环
     */
    static List<Integer> eventualSafeNodes(int[][] graph) {
        List<Integer> ans = new ArrayList<>();//记录结果
    ...
    private static void testEventualSafeNodes() {
        //                0       1       2    3    4   5   6
        int[][] graph = {{1, 2}, {2, 3}, {5}, {0}, {5}, {}, {}};
        List<Integer> res1 = eventualSafeNodes(graph);
        System.out.println(res1);
    }

    public static void main(String[] args) {
        testEventualSafeNodes();
    }
}
