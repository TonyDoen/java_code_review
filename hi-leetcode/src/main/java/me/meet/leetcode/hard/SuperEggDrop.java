...
public final class SuperEggDrop {
    private SuperEggDrop() {}

    /**
     * url: https://www.cnblogs.com/grandyang/p/11048142.html
     * url: https://leetcode.com/problems/super-egg-drop/
     * url: https://www.cnblogs.com/Phantom01/p/9490508.html
     * url: https://www.acwing.com/solution/leetcode/content/579/
     * url: https://leetcode.com/problems/super-egg-drop/discuss/159508/easy-to-understand
     * url: https://leetcode.com/problems/super-egg-drop/discuss/299526/BinarySearch-or-Easiest-or-Explanation
     * url: https://leetcode.com/problems/super-egg-drop/discuss/158974/C%2B%2BJavaPython-2D-and-1D-DP-O(KlogN)
     * url: https://leetcode.com/problems/super-egg-drop/discuss/181702/Clear-C%2B%2B-codeRuntime-0-msO(1)-spacewith-explation.No-DPWhat-we-need-is-mathematical-thought!
     *
     ...
     */
    static int superEggDrop3(int k, int n) {
     ...
     */
    static int superEggDrop4(int k, int n) {
        int[] dp = new int[k + 1];
        int res = 0;
        for (; dp[k] < n; ++res) {
            for (int i = k; i > 0; --i) {
     ...
     */
    static int superEggDrop5(int K, int N) {
        int left = 1, right = N;
        while (left < right) {
            int mid = left + (right - left) / 2;
    ...
    static int helper(int x, int K, int N) {
        int res = 0, r = 1;
        for (int i = 1; i <= K; ++i) {
            r *= x - i + 1;
            r /= i;
    ...
    private static void testSuperEggDrop() {
        ...
        int res3 = superEggDrop3(k, n);
        int res4 = superEggDrop4(k, n);
