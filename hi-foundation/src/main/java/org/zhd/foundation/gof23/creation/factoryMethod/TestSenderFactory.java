...
import org.zhd.foundation.gof23.creation.abstractFactory.MailSenderFactory;
import org.zhd.foundation.gof23.creation.abstractFactory.Provider;
...
public class TestSenderFactory {
    public static void main(String[] args) {
        ...
        org.zhd.foundation.gof23.creation.abstractFactory.Sender tmp = pr.produce();
        tmp.send();
    }
    // 总结
